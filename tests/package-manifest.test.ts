...
test("package verification binds the published Gentle AI v3.0.2 runtime pin", () => {
	...
	assert.match(installer, /INSTALLER_VERSION = "3\.0\.2"/);
	assert.match(installer, /GENTLE_AI_WINDOWS_SOURCE_PACKAGE.*GENTLE_AI_WINDOWS_SOURCE_MODULE/);
	assert.match(installer, /GENTLE_AI_WINDOWS_SOURCE_MODULE_CHECKSUM = "h1:UtealViTal0mOI4pdDExGTsv48\/wlLJK1WWZphmQblI="/);
