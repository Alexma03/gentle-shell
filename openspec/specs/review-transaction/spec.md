...
- GIVEN Pi negotiates against the pinned v3.0.2 provider
...
- GIVEN `.gentle-ai/` holds only pre-v3.0.2 runtimes
- WHEN Pi resolves the pinned executable
- THEN negotiation fails hard, naming the expected v3.0.2 version, rather than degrading to an older runtime
