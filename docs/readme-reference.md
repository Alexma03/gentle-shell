...
This checkout prepares `gentle-pi` `3.1.0`; it is source state, not a published release. Its package-local native runtime pin is Gentle AI `v3.0.2`, distinct from the published `v2.6.0` pairing.
...
3.0.2 pin, native still requires verification and its emitted evidence requirements;
