...
async function main() {
  ...
  if (driftedContracts.length > 0) {
    console.error("gentle-pi packaged review-integration/v1 and review-integration/v2 contract bytes drifted from the pinned v3.0.2 runtime's vendored Gentle AI contract artifacts:");
  ...
  console.log(`gentle-pi package resource check passed (${requiredPaths.length} files; ${Object.keys(contractHashes).length} exact byte-pinned contract artifacts for the v3.0.2 runtime).`);
}
